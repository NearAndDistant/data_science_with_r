...
ggplot(aes(x = x, 
  ...
  theme(axis.text.x = element_blank(),
        plot.margin = margin(0,-5.5,0,-5.5,unit = "cm"))
...
main_text <- 
"An Emmy Award, or simply Emmy, is a trophy presented at one of the numerous annual American\nevents or competitions that each recognize achievements in a particular sector of the television\nindustry. The Emmy is considered one of the four major entertainment awards in the United States,\nthe others being the Grammy (for music), the Oscar (Academy Award) (for film), and the Tony (for theatre).\nThe two events that receive the most media coverage are the Primetime Emmy Awards and the Daytime Emmy Awards,\nwhich recognize outstanding work in American primetime and daytime entertainment programming, respectively.\n\nHere we show those companies which have at least 10 nominations in the Primetime Emmy Awards main categories for:\nOutstanding Programs, Writing, Directing, Lead Actors and Actresses, as well as Supporting Actors and Actresses."

ggdraw(emmy_sankey) +
  draw_text("Emmy Awards\nand\nNominees" , family = "cutive_bold" , hjust = 1, size = 20, x = 0.91 , y = 0.9) +
