...
f1_tot_points %>%
  ggplot(aes(pc_point , season , fill = fct_rev(constructor_lump))) +
...
f1_season_top %>%
  ggplot(aes(season , position)) +
  ggstream::geom_stream(aes(fill = constructor_lump) , show.legend = FALSE) +
  scale_fill_manual(values = palette) +
  #scale_x_continuous(breaks = seq(1950, max(f1_season_top$season) , 10))
