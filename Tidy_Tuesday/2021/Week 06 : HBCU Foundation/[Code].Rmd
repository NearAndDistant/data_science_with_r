...
ggplot(aes(x = x + (n_year/5), y = -y)) +
  geom_text(aes(label = plot_year), 
            ...
            show.legend = FALSE, color = "grey80", alpha = 0.3) +
  geom_text(data = hbcu_mask_long , 
            aes(label = plot_year, color = ethnicity), 
            hjust = 0 , size = 10, family = font, show.legend = FALSE) +
  labs(color = NULL) +
...
ggdraw() +
  ...
  annotate(geom = "curve" , x = 0.88, y = 0.95, xend = 0.8475, yend = 0.90, curvature = 0.5 , arrow = arrow(length = unit(0.01, "npc"))) +
  annotate(geom = "curve" , x = 0.78, y = 0.95, xend = 0.8075, yend = 0.90, curvature = -0.5 , arrow = arrow(length = unit(0.01, "npc"))) +
  draw_text("Black                              White" , x = 0.75, y = 0.95 , hjust = 0 , family = "blm") +
  annotate(geom = "segment" , x = 0.79 , xend = 0.94 , y = 0.80 , yend = 0.80 , arrow = arrow(length = unit(0.01, "npc"), ends = "both")) +
  draw_text("          |         |          |      ", x = 0.79 , y = 0.802, hjust = 0) +
  draw_text("10%     20%     30%      40%     50%", x = 0.79 , y = 0.78, hjust = 0, family = "patrick") +
  draw_text("Percentage of Graduates", x = 0.795 , y = 0.755, hjust = 0, family = "blm") 
...
ggsave(plot = hbcu_sankey , here::here("Week 06 : HBCU Foundation/hbcu_sankey.png"), dpi = 360, height = 40, width = 18)
