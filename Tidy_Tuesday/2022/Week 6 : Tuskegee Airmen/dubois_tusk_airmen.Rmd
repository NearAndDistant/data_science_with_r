...
map_dubois_tusk <-
  ...
  geom_polygon(data = us_tusks, aes(x = long, y = lat, fill = cut, group = group),
               color = "grey30", linetype = "dotdash", alpha = 0.70, size = 0.2, show.legend = FALSE) +
  scale_fill_manual(values = c("#e1b457", "#021f69", "#d32150", "#624025", "#141412")) +
  # points
  geom_point(data = us_tusks, aes(x = long, y = lat, color = cut), alpha = 0) +
  scale_color_manual(values = c("#e1b457", "#021f69", "#d32150", "#624025", "#141412")) +
  ...
  theme(legend.position  = c(0.50,1.15),
        ...
        plot.margin      = margin(8,-4.5,0,-4, unit = "cm"))
...
draw_text("DISTRIBUTION OF THE TUSKEGEE AIRMEN IN THE UNITED STATES", family = "teko", fontface = "bold", size = 20, color = "grey25", 
          x = 0.5, y = 0.96) +
draw_text("DISTRIBUTION DES TUSKEGEE AIRMEN DAN LES ETATS UNIS", family = "coda", size = 12, color = "grey25", 
          x = 0.5, y = 0.93)
...
grid.brackets(300,300,130,400,lwd=0.2,ticks=0.54,h=.030,curvature=0.20,col="grey60",type=5)
